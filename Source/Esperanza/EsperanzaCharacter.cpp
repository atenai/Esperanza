...
AEsperanzaCharacter::AEsperanzaCharacter()
{
...
void AEsperanzaCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AEsperanzaCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) 
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AEsperanzaCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AEsperanzaCharacter::Look);
...
void AEsperanzaCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
